...
<div className='w-3/5 flex flex-col justify-center gap-12'>
    <div >
        ...
        <p className='line-through font-base text-gray-500'>${details.oldPrice}</p>
            <p className='text-2l font-medium text-gray-900'>${details.price}</p>
        </div>
        </div>
        ...
        <div className='flex gap-4'>
            ...
            <button className='bg-black text-white py-3 px-6 active: active:bg-gray-800'>
                add to cart
            </button>

        </div>
   <p className='text-base text-gray-500' >Catagory: <span className='font-medium capitalize'>{details.category}</span> </p>
